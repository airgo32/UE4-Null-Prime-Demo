 ...
 */
class FOnlineSessionNullPrime : public IOnlineSession
{
private:
	 ...
	 */
	void AppendSessionToPacket(class FNboSerializeToBufferNullPrime& Packet, class FOnlineSession* Session);
	 ...
	 */
	void AppendSessionSettingsToPacket(class FNboSerializeToBufferNullPrime& Packet, FOnlineSessionSettings* SessionSettings);
	 ...
	 */
	void ReadSessionFromPacket(class FNboSerializeFromBufferNullPrime& Packet, class FOnlineSession* Session);
	 ...
	 * @param SessionSettings the session settings to copy the data to
	 */
	void ReadSettingsFromPacket(class FNboSerializeFromBufferNullPrime& Packet, FOnlineSessionSettings& SessionSettings);
	 ...
	 */
	static void SetPortFromNetDriver(const FOnlineSubsystemNullPrime& Subsystem, const TSharedPtr<FOnlineSessionInfo>& SessionInfo);
...
PACKAGE_SCOPE:
	...
	FOnlineSessionNullPrime(class FOnlineSubsystemNullPrime* InSubsystem) :
...
public:
	...
	virtual ~FOnlineSessionNullPrime() {}
...
typedef TSharedPtr<FOnlineSessionNullPrime, ESPMode::ThreadSafe> FOnlineSessionNullPrimePtr;
